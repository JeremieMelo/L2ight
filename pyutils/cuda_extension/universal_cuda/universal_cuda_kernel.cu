...
__global__ void uftBatch1Kernel(ComplexType<float> *d_Output, ComplexType<float> *d_Input, int log2N)
{
 ...
 ////////////////////////////////////////////////////////////////////////////////
__global__ void uftBatch2Kernel(
    ComplexType<float> *d_Output,
    ComplexType<float> *d_Input,
    int stride
)
{
...
__global__ void iuftBatch1Kernel(ComplexType<float> *d_Output, ComplexType<float> *d_Input, int log2N)
{
    // Handle to thread block group
    cg::thread_block cta = cg::this_thread_block();
    const int    N = 1 << log2N;
 ...
 // (for strides exceeding elementary vector size)
 ////////////////////////////////////////////////////////////////////////////////
__global__ void iuftBatch2Kernel(
    ComplexType<float> *d_Output,
    ComplexType<float> *d_Input,
    int stride
)
