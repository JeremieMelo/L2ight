...
def task_launcher(args):
    ...
    with open(os.path.join(root, f'swat_norm-{fws_norm}_fws-{fws_alg}-{fws}_norm-{ss_norm}_ss-{ss}_run-{id}.log'), 'w') as wfid:
        exp = [
...
if __name__ == '__main__':
    ...
    tasks = [[0.3, "uniform", "exp", 0.6, "none", 1]] # 31751  05:31 PM 05/05
