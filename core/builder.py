...
import torchvision
from pyutils.dataset import get_dataset
from pyutils.typing import DataLoader, Optimizer, Scheduler
from torch.types import Device
from torchpack.utils.config import configs

from core.models import *
from core.optimizer import MixedTrainOptimizer, FLOPSOptimizer

__all__ = ["make_dataloader", "make_model", "make_optimizer",
           "make_scheduler", "make_criterion"]


def make_dataloader() -> Tuple[DataLoader, DataLoader]:
    train_dataset, validation_dataset = get_dataset(configs.dataset.name,
        configs.dataset.img_height, configs.dataset.img_width, dataset_dir=configs.dataset.root, transform=configs.dataset.transform)
